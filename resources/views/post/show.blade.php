...
<div class="container mx-auto md:flex">
    <div class="md:w-1/2">
        ...
        <form action="{{route ('posts.destroy', $post) }}" method="POST">
            @method('DELETE')
            @csrf
            <input type="submit" value="Eliminar" class="bg-red-500 hover:bg-red-600 p-2 rounded text-white font-bold mt-4 cursos-pointer" />
        </form>
        @endif
        @endauth
    </div>
        ...
        <div class="shadow bg-white p-5 mb-5">
            ...
            <form action="{{route ('comentarios.store', ['post' => $post, 'user' => $user]) }}" method="POST">
                ...
                <div class="mb-5x">
                    ...
                    <textarea id="comentario" name="comentario" placeholder="Agrega un comentario" class="border p-3 w-full rounded-lg @error('comentario') border-red-600 @enderror"></textarea>
                    @error('comentario')
